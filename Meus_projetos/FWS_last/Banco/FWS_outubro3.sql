...
CREATE DATABASE IF NOT EXISTS `fws` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fws`;
...
-- Copiando dados para a tabela fws.carrinho: ~3 rows (aproximadamente)
INSERT INTO `carrinho` (`id`, `usuario_id`, `produto_id`, `quantidade`, `preco_unitario`, `codigo_cupom`, `data_criacao`) VALUES
	...
	(154, 4, 1, 1, 69.90, NULL, '2025-12-09 03:10:00'),
	(155, 4, 2, 3, 69.90, NULL, '2025-12-09 03:10:00'),
	(156, 4, 48, 2, 6.50, NULL, '2025-12-09 03:10:00'),
	(157, 4, 57, 2, 7.50, NULL, '2025-12-09 03:10:00'),
	(158, 4, 18, 1, 9.99, NULL, '2025-12-09 06:07:41');
...
-- Copiando dados para a tabela fws.despesas: ~2 rows (aproximadamente)
INSERT INTO `despesas` (`id`, `descricao`, `valor`, `data_despesa`, `tipo`, `categoria_id`) VALUES
	(1, '', 100.00, '2025-12-05', 'manutencao', NULL),
...
-- Copiando dados para a tabela fws.expiracoes_pre_compras: ~23 rows (aproximadamente)
...
INSERT INTO `funcionarios` (`id`, `nome`, `cpf`, `email`, `senha`, `nivel_permissao`, `criado_em`, `ultimo_login`, `ativo`) VALUES
	(1, 'Mônica alves', '123.456.789-10', 'Monica@redecampeao.com.sp', '$2y$10$6hajNuGfFlg6txtji4XJ..HQCDtd.bonljgRVxPfqEE30GIOXNxIu', 3, '2025-08-13 13:43:01', '2025-12-09 05:18:11', 1);
...
-- Copiando dados para a tabela fws.lotes_produtos: ~159 rows (aproximadamente)
INSERT INTO `lotes_produtos` (`id`, `produto_id`, `validade`, `quantidade`, `fornecedor_id`, `chegada`) VALUES
	...
	(20, 5, '2026-11-26', 8, 3, '2025-11-26'),
	...
	(37, 22, '2026-11-26', 10, 9, '2025-11-26'),
	...
	(48, 33, '2026-11-26', 4, 9, '2025-11-26'),
	...
	(62, 48, '2026-11-26', 6, 3, '2025-11-26'),
	...
	(71, 57, '2026-11-26', 1, 10, '2025-11-26'),
	...
	(149, 18, '2026-12-05', 18, 9, '2025-12-05'),
	...
	(159, 43, '2026-12-05', 23, 12, '2025-12-05'),
	...
	(167, 1, '2028-12-05', 19, 1, '2025-12-05'),
...
-- Copiando dados para a tabela fws.movimentacao_estoque: ~113 rows (aproximadamente)
...
INSERT INTO `produtos` (`id`, `nome`, `categoria_id`, `fornecedor_id`, `descricao`, `foto_produto`, `preco_venda`, `preco_compra`, `estoque`, `validade_padrao_meses`, `status`, `criado_em`) VALUES
	(1, 'VINHO MALBEC 750ML', 1, 1, 'Um vinho Malbec elegante, produzido com uvas selecionadas que garantem sabor intenso, aromas frutados e taninos suaves. Ideal para acompanhar carnes vermelhas e momentos especiais.', '/fws/IMG_Produtos/1.png', 69.90, 54.90, 42, 36, 'ativo', '2025-10-20 17:54:49'),
	(2, 'VINHO DE LOS MAN CABERNET SAUVIGNON BRANCO 750ML', 1, 1, 'Vinho Cabernet Sauvignon, disponível nas versões branco ou tinto, feito com uvas premium que trazem equilíbrio entre acidez e corpo, perfeito para harmonizar com queijos e pratos sofisticados.', '/fws/IMG_Produtos/2.png', 69.90, 54.90, 51, 36, 'ativo', '2025-10-20 17:54:49'),
	...
	(5, 'ÁGUA DE COCO KERO COCO CX 200ML', 2, 3, 'Compacta e nutritiva, essa água de coco oferece hidratação natural e energia, com sabor refrescante e leve, ótima para levar na bolsa ou lancheira.', '/fws/IMG_Produtos/5.png', 6.90, 3.20, 17, 12, 'ativo', '2025-10-20 17:54:49'),
	...
	(10, 'ÁGUA TONICA ANTARCTICA DIET LT 350ML', 2, 7, 'Água tônica dietética Antarctica, com sabor marcante e refrescante, adoçada artificialmente para quem busca sabor sem calorias.', '/fws/IMG_Produtos/10.png', 8.00, 2.60, 30, 12, 'ativo', '2025-10-20 17:54:49'),
	...
	(15, 'BALA DROPS HALLS MENTOL PCT 28G', 4, 8, 'Bala Drops Halls Mentol, combinando frescor e alívio imediato para a garganta, ideal para dias frios ou ambientes secos.', '/fws/IMG_Produtos/15.png', 3.50, 1.19, 35, 12, 'ativo', '2025-10-20 17:54:49'),
	...
	(18, 'BALA FINI BEIJOS MORANGO DE GELATINA PCT 100G', 4, 9, 'Bala de gelatina Fini formato beijo sabor morango, macia e saborosa, perfeita para adoçar o dia com uma explosão de sabor frutado.', '/fws/IMG_Produtos/18.png', 9.99, 4.99, 12, 12, 'ativo', '2025-10-20 17:54:49'),
	...
	(22, 'BALA FRUITTELLA MORANGO C CREME LEITE PCT 45G', 4, 9, 'Bala sabor morango com creme de leite, combinação irresistível de sabor e suavidade.', '/fws/IMG_Produtos/22.png', 3.99, 1.96, 34, 12, 'ativo', '2025-10-30 12:59:48'),
	...
	(33, 'BARRA DE CEREAL SUPINO PROTEIN CAPPUCCINO PCT 30G', 5, 9, 'Barra proteica sabor cappuccino, ideal para recuperação muscular e energia extra.', '/fws/IMG_Produtos/33.png', 8.50, 3.64, 28, 12, 'ativo', '2025-10-30 13:02:47'),
	...
	(43, 'BEB LACTEA 3 CORACOES CAPPUCCINO CHOCOLATE CX 260ML', 7, 12, 'Bebida láctea sabor cappuccino com chocolate, cremosa e nutritiva, perfeita para qualquer momento.', '/fws/IMG_Produtos/43.png', 12.50, 5.72, 23, 12, 'ativo', '2025-10-30 13:04:29'),
	...
	(48, 'BEB LACTEA TODDYNHO LEVINHO CX 200ML', 7, 3, 'Bebida láctea Toddy Leve, sabor chocolate suave, ideal para lanches rápidos e deliciosos.', '/fws/IMG_Produtos/48.png', 6.50, 2.35, 30, 12, 'ativo', '2025-10-30 13:04:29'),
	...
	(57, 'BISC BAUDUCCO WAFER MAXI CHOCOLATE PCT 104G', 8, 10, 'Wafer Bauducco Maxi chocolate, sabor intenso e textura crocante, ideal para crianças e adultos.', '/fws/IMG_Produtos/57.png', 7.50, 3.45, 25, 12, 'ativo', '2025-10-30 13:07:21'),
...
-- Copiando dados para a tabela fws.retiradas: ~8 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `nome`, `data_nascimento`, `telefone`, `cpf`, `email`, `senha`, `criado_em`, `ultimo_login`, `ativo`, `google_id`) VALUES
	(4, 'NIKOLAS DE SOUZA ', '2007-01-09', '(11) 96854-4147', '47944286859', 'nikolas.souzalima007@gmail.com', '$2y$10$DN2sT4jhtzeogW.CVlBzb.Y2s0n.6pp3tswHQb.R7yXe2eLg43ZFq', '2025-10-20 23:59:00', '2025-12-09 05:11:11', 0, NULL),
...
CREATE TABLE IF NOT EXISTS `vendas` (
  ...
  `situacao_compra` enum('em_preparo','pronto_para_retirar','finalizada','cancelada') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'em_preparo',
  ...
  `tempo_adicionado` enum('S','N') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'N',
  PRIMARY KEY (`id`),
  KEY `funcionario_id` (`funcionario_id`),
  KEY `usuario_id` (`usuario_id`),
...
-- Copiando dados para a tabela fws.vendas: ~33 rows (aproximadamente)
